...
public class HealAtk : Skill
{
  ...
  {
      BoardProxy.instance.GetTileAtPosition(attacker.GetPosition()).CreateAnimation(Glossary.fx.healSmoke, AnimationInteractionController.ATK_WAIT);
  ...
  public override string PrintDetails(){
      return "Heal self on successful enemy attack. " + ReturnBlurbByString(GetSkillGen());
  }
